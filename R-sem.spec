...
Version  : 3.1.14
Release  : 45
URL      : https://cran.r-project.org/src/contrib/sem_3.1-14.tar.gz
Source0  : https://cran.r-project.org/src/contrib/sem_3.1-14.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1646931629
