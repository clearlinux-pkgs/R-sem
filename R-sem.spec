...
export LANG=C
export SOURCE_DATE_EPOCH=1521229411
...
R CMD check --no-manual --no-examples --no-codoc -l %{buildroot}/usr/lib64/R/library sem|| : 
cp ~/.stash/* %{buildroot}/usr/lib64/R/library/*/libs/ || :
...
/usr/lib64/R/library/sem/libs/symbols.rds
